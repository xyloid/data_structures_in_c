...
//   - (i.e. queue_t* create_queue(unsigned int _capacity) should not have
...
int queue_enqueue(queue_t *q, int item) {
	// Return -1 for NULL pointer and full stack.
	if (q == NULL) {
		return -1;
